...
public class ProductFunctions {
    ...
    public void updateItemQuantity(Statement st, String item, int newQuantity) throws SQLException {
        String query = "update " + tableName + " set quantity= " + newQuantity + " where productName= '" + item + "'";
        int x = st.executeUpdate(query);
        if (x == 0) {
